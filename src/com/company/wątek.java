...
public class wątek extends Thread{
    ...
    public void windows(){
        ...
        if(Main.pokój[34]==false) {
            Main.gra.getContentPane().getComponent(38).setVisible(false);
        }
        if(Main.pokój[34]==true) {
            Main.gra.getContentPane().getComponent(38).setVisible(true);
        }

        if(Main.pokój[35]==false) {
            Main.gra.getContentPane().getComponent(39).setVisible(false);
        }
        if(Main.pokój[35]==true) {
            Main.gra.getContentPane().getComponent(39).setVisible(true);
        }

        if(Main.pokój[36]==false) {
            Main.gra.getContentPane().getComponent(40).setVisible(false);
        }
        if(Main.pokój[36]==true) {
            Main.gra.getContentPane().getComponent(40).setVisible(true);
        }

        if(Main.pokój[37]==false) {
            Main.gra.getContentPane().getComponent(41).setVisible(false);
        }
        if(Main.pokój[37]==true) {
            Main.gra.getContentPane().getComponent(41).setVisible(true);
        }

        if(Main.pokój[38]==false) {
            Main.gra.getContentPane().getComponent(42).setVisible(false);
        }
        if(Main.pokój[38]==true) {
            Main.gra.getContentPane().getComponent(42).setVisible(true);
        }

        if(Main.pokój[39]==false) {
            Main.gra.getContentPane().getComponent(43).setVisible(false);
        }
        if(Main.pokój[39]==true) {
            Main.gra.getContentPane().getComponent(43).setVisible(true);
        }

        if(Main.pokój[40]==false) {
            Main.gra.getContentPane().getComponent(44).setVisible(false);
        }
        if(Main.pokój[40]==true) {
            Main.gra.getContentPane().getComponent(44).setVisible(true);
        }

        if(Main.pokój[41]==false) {
            Main.gra.getContentPane().getComponent(45).setVisible(false);
        }
        if(Main.pokój[41]==true) {
            Main.gra.getContentPane().getComponent(45).setVisible(true);
        }
    }
    ...
    public void play(File sound){
            ...
            try {
                    ...
                    if (Main.musicsec%(25*349)==1){
                        ...
                        AudioInputStream muzyka = AudioSystem.getAudioInputStream(sound);

                        Main.muzykadogry.open(muzyka);
                    ...
                    if (Main.start == true) {
                        ...
                        Main.muzykadogry.loop(Clip.LOOP_CONTINUOUSLY);
                    }
