...
public class Pokoje {
     ...
     public static void Llekow(com.company.Postac postac, com.company.Przedmiot opatrunki, com.company.Przedmiot odtrutka, com.company.Przedmiot trutka){
         int c = 0;
         c = (int)(Math.random()*3);
         if(c>=0 && c<=1){
     ...
     public static void Lbroni(com.company.Postac postac, com.company.Przedmiot miecz, com.company.Przedmiot tarcza){
         int c = 0;
         c = (int)(Math.random()*3);
         if(c>=0 && c<=1){
             if(miecz.ilosc == 1){
     ...
     public static void Lposilku(com.company.Postac postac, com.company.Przedmiot jablko, com.company.Przedmiot trutka, com.company.Przedmiot mieso){
         int c = 0;
         c = (int)(Math.random()*9);
if(c>=0 && c<=2){
...
public static void Lwygranej(com.company.Postac postac, com.company.Przedmiot miecz, com.company.Przedmiot toporek, com.company.Przedmiot tarcza){
    int c = 0;
   ...
   if(miecz.ilosc == 1 && toporek.ilosc == 1 && tarcza.ilosc == 1 && c%2==0){
    ...
    public static void listy(Scanner sc, com.company.Postac postac){
        int w = 0;
    ...
    public static void topor(Scanner sc, com.company.Postac postac, com.company.Przedmiot toporek) {
        int w = 0;
    ...
    public static void pusto(com.company.Postac postac) {
    ...
    public static void smok(Scanner sc, com.company.Postac postac, com.company.Przedmiot miecz, com.company.Przedmiot toporek, com.company.Przedmiot tarcza, com.company.Przedmiot chlopiec){
        int w = 0;
    ...
    public static void ksiezniczka(Scanner sc, com.company.Postac postac){
        int w = 0;
    ...
    public static void przyjaciel(Scanner sc, com.company.Postac postac, com.company.Przedmiot chlopiec){
         int w = 0;
    ...
    public static void skrzynia(Scanner sc, com.company.Postac postac, com.company.Przedmiot jablko, com.company.Przedmiot mieso, com.company.Przedmiot trutka, com.company.Przedmiot opatrunki, com.company.Przedmiot odtrutka, com.company.Przedmiot miecz, com.company.Przedmiot tarcza){
         int w = 0;
...
switch (w){
    ...
    case 2:
     ...
     public static void smieci(Scanner sc, com.company.Postac postac){
         int w = 0;
    ...
    public static void aplubj(Scanner sc, com.company.Postac postac, com.company.Przedmiot jablko, com.company.Przedmiot mieso, com.company.Przedmiot trutka, com.company.Przedmiot opatrunki, com.company.Przedmiot odtrutka){
         int w = 0;
    ...
    public static void koniec(com.company.Postac postac){
         System.out.println("Wygrałeś");
         postac.gramy = false;
    }

public static void przeciwnik(com.company.Postac postac, com.company.Przedmiot miecz, com.company.Przedmiot toporek, com.company.Przedmiot tarcza) {
    System.out.println("Spotkałeś coś potwornego. Musisz z tym walczyć.");
    Lwygranej(postac, miecz, toporek, tarcza);

}

public static void jedzenie(com.company.Postac postac, com.company.Przedmiot trutka, com.company.Przedmiot mieso, com.company.Przedmiot jablko){
Lposilku(postac, trutka, mieso, jablko);

}

public static void bron(com.company.Postac postac, com.company.Przedmiot miecz, com.company.Przedmiot tarcza){
Lbroni(postac, miecz, tarcza);

}

public static void opatrunki(Postac postac, com.company.Przedmiot opatrunki, com.company.Przedmiot odtrutka, Przedmiot trutka){
